...
## 2026-06-25 - Extract Form Input Dictionary Logic
**Learning:** Extracting repeated logic when reading from dictionary-shaped `formInput` payload ensures consistency and readability, minimizing inline find patterns.
**Action:** Created `findDictionaryInput` helper and updated form input extraction functions to use it.
