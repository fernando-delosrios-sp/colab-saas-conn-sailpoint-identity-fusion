...
| **Delete accounts with no managed accounts left?**    | Yes                   | Auto-cleanup when person leaves organization and all source accounts are removed. Also removes identity-origin Fusion accounts whose origin identity is no longer in the configured identity scope                                                                                                                                                                                                              |
