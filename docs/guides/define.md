...
!!! warning "Note"
    ...
    Use `$MD5` for deterministic identifiers compatible with downstream systems — not for password or secret hashing. MD5 is cryptographically weak and unsuitable for security-sensitive use.
