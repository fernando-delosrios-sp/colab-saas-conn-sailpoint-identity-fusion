...
| **Algorithm mismatch**                   | Check algorithm for attribute type         | Use appropriate algorithm (see [Matching algorithms](../configuration/tuning-matching-algorithms.md)) |
...
| Cause                           | Diagnostic                   | Solution                                                      |
| ------------------------------- | ---------------------------- | ------------------------------------------------------------- |
| **Server returns wrong format** | Check server response        | Return NDJSON or JSON array (see [Proxy mode](../../reference/proxy-mode.md)) |
