...
| **Processing wait time (seconds)** | 60 | 0–600 | Keep-alive interval during long account list/update |
| **Heartbeat interval (seconds)** | 10 | 5+ | How often `STATUS` and `EVENT_SUMMARY` lines emit |
