...
| [Configuring sources](configuration/configuring-sources.md) | Source settings, scope, aggregation timing, and correlation modes. |
| [Review forms and reviewers](configuration/review-forms-and-reviewers.md) | Review form configuration, reviewer assignment, and decision workflows. |
