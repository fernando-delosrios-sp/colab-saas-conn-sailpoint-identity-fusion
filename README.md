...
| **Send report to owner on aggregation?**           | Email report to owner after each aggregation     | No       | Includes matches and processing summary                                                                                                                                                                                                                                                                       |
...
| [Match](docs/guides/match.md)                                                            | Detect and resolve matching identities using one or more sources.                                  |
...
| **actions**          | string (entitlement) | Yes   | Assigned actions (e.g. `correlated`, `reviewer:<sourceId>`). **Note:** All Action entitlements are requestable. The `report` entitlement can be requested to generate a report of aggregated results without actually aggregating the source.                                          |
