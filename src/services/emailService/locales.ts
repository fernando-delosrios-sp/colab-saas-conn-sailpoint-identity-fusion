...
export const locales: Record<string, TranslationDictionary> = {
    en: {
        ...
        email_header_subtitle: '{{host}} - {{sourceName}}',
        fusion_source_fallback: 'Fusion source',        processing_statistics: 'Processing Statistics',
        ...
        please_review: 'Please review the match and take appropriate action.',
        ...
        aggregation_report_title: 'Identity Fusion Aggregation Report',
        ...
        combined_score_attribute: 'Combined score',
    ...
    es: {
        ...
        email_header_subtitle: '{{host}} - {{sourceName}}',
        fusion_source_fallback: 'Fuente Fusion',        processing_statistics: 'Estadísticas de procesamiento',
        ...
        please_review: 'Revise la coincidencia y tome la acción adecuada.',
        ...
        aggregation_report_title: 'Reporte de agregación de Identity Fusion',
        ...
        combined_score_attribute: 'Puntuación combinada',
...
form_score_value_na: 'Valor: N/D',
    ...
    fr: {
        ...
        email_header_subtitle: '{{host}} - {{sourceName}}',
        fusion_source_fallback: 'Source Fusion',        processing_statistics: 'Statistiques de traitement',
        ...
        please_review: 'Veuillez examiner la correspondance et prendre les mesures appropriées.',
        ...
        aggregation_report_title: 'Rapport d\'agrégation Identity Fusion',
        ...
        combined_score_attribute: 'Score combiné',
...
form_score_value_na: 'Valeur : N/D',
    ...
    de: {
        ...
        email_header_subtitle: '{{host}} - {{sourceName}}',
        fusion_source_fallback: 'Fusion-Quelle',        processing_statistics: 'Verarbeitungsstatistiken',
        ...
        please_review: 'Bitte überprüfen Sie die Übereinstimmung und ergreifen Sie die entsprechenden Maßnahmen.',
        ...
        aggregation_report_title: 'Identity Fusion Aggregationsbericht',
        ...
        combined_score_attribute: 'Kombinierter Score',
        form_score_skipped: 'Übersprungen (fehlender Wert)',
        form_score_only: 'Punktzahl: {{score}}',
        form_score_only_with_fusion: 'Punktzahl: {{score}} [{{fusionScore}}]',
        form_score_value_combined: 'Wert: {{value}} | Punktzahl: {{score}} [{{fusionScore}}]',
        form_score_value_fusion: 'Wert: {{value}} [{{fusionScore}}]',
        form_score_value_only: 'Wert: {{value}}',
        form_score_value_na: 'Wert: k. A.',
        form_toggle_new_identity: 'Neue Identität',
        form_toggle_no_match: 'Keine Übereinstimmung',
        form_toggle_true: 'Wahr',
        form_toggle_false: 'Falsch',
        form_toggle_help_new_identity: 'Wählen Sie dies, wenn das Konto eine neue Identität ist',
        form_toggle_help_no_match_record: 'Wählen Sie dies, wenn der Datensatz keiner bestehenden Identität entspricht',
        form_toggle_help_no_match_orphan:
            'Wählen Sie dies, wenn das verwaiste Konto keiner bestehenden Identität entspricht',
        form_fusion_score_details_header:
            '<p style="text-align: center;"><span style="font-size: 18pt;"><strong>Fusion-Score-Details</strong></span></p>',
        form_fusion_score_details_label: 'Fusion-Score-Details',
        form_section_desc_authoritative:
            'Eine potenzielle übereinstimmende Identität wurde erkannt. Bitte prüfen Sie die Kandidatenidentitäten unten und wählen Sie entweder eine bestehende Identität zum Zusammenführen oder erstellen Sie eine neue Identität.',
        form_section_desc_record:
        ...
        form_decisions: 'Entscheidungen',
        form_fusion_decision: 'Fusion-Entscheidung',
        form_candidate_details: 'Details zu {{name}}',
        form_definition_description:
            'Prüfen Sie die potenzielle übereinstimmende Identität und entscheiden Sie, ob eine neue Identität erstellt oder mit einer bestehenden zusammengeführt werden soll',
    },
    zh: {
        curated_view: '潜在匹配项及其评分依据的精选视图。',

        email_header_subtitle: '{{host}} - {{sourceName}}',
        fusion_source_fallback: 'Fusion 源',        processing_statistics: '处理统计信息',
        phase_timing: '阶段耗时',
        ...
        blended: 'Blended',
        blended_account: 'Blended Account',
        review_email_subject: '{{accountName}} ({{accountSource}}) - 审核候选身份匹配',
        report_email_subject: '{{reportTitle}} - {{matchCount}} 个匹配项需要您关注',
        truncation_notice: 'Report content was truncated to fit ISC workflow input size limits.',
        dry_run_report_title: 'Identity Fusion Dry Run Report',
        fusion_report_title: 'Identity Fusion Report',
        aggregation_report_title: 'Identity Fusion Aggregation Report',
        ...
        algorithm_binary: 'Binary (Exact Match)',
        algorithm_custom: 'Custom',
        algorithm_average: '综合匹配分数（旧版）',
        algorithm_weighted_mean: '综合评分',

        combined_score_attribute: '综合评分',
        form_score_skipped: 'Skipped (missing value)',
        form_score_only: 'Score: {{score}}',
        form_score_only_with_fusion: 'Score: {{score}} [{{fusionScore}}]',
        form_score_value_combined: 'Value: {{value}} | Score: {{score}} [{{fusionScore}}]',
    ...
    ja: {
        ...
        email_header_subtitle: '{{host}} - {{sourceName}}',
        fusion_source_fallback: 'Fusion ソース',        processing_statistics: '処理統計',
        ...
        please_review: '一致を確認し、適切な対応を行ってください。',
        ...
        blended: 'Blended',
        blended_account: 'Blended Account',
        review_email_subject: '{{accountName}} ({{accountSource}}) - 候補アイデンティティ一致を確認',
        report_email_subject: '{{reportTitle}} - {{matchCount}} 件の一致が確認を必要としています',
        truncation_notice: 'Report content was truncated to fit ISC workflow input size limits.',
        dry_run_report_title: 'Identity Fusion Dry Run Report',
        fusion_report_title: 'Identity Fusion Report',
        aggregation_report_title: 'Identity Fusion Aggregation Report',
        ...
        algorithm_binary: 'Binary (Exact Match)',
        algorithm_custom: 'Custom',
        algorithm_average: '総合マッチスコア（レガシー）',
        algorithm_weighted_mean: '総合スコア',

        combined_score_attribute: '総合スコア',
        form_score_skipped: 'スキップ（値なし）',
        form_score_only: 'スコア: {{score}}',
        form_score_only_with_fusion: 'スコア: {{score}} [{{fusionScore}}]',
        form_score_value_combined: '値: {{value}} | スコア: {{score}} [{{fusionScore}}]',
        form_score_value_fusion: '値: {{value}} [{{fusionScore}}]',
        form_score_value_only: '値: {{value}}',
        form_score_value_na: '値: N/A',
        form_toggle_new_identity: '新規アイデンティティ',
        form_toggle_no_match: '一致なし',
        form_toggle_true: 'はい',
        form_toggle_false: 'いいえ',
        form_toggle_help_new_identity: 'アカウントが新規アイデンティティの場合はこれを選択してください',
        form_toggle_help_no_match_record:
            'レコードが既存のアイデンティティと一致しない場合はこれを選択してください',
        form_toggle_help_no_match_orphan:
            '孤立アカウントが既存のアイデンティティと一致しない場合はこれを選択してください',
        form_fusion_score_details_header:
            '<p style="text-align: center;"><span style="font-size: 18pt;"><strong>Fusion スコアの詳細</strong></span></p>',
        form_fusion_score_details_label: 'Fusion スコアの詳細',
        form_section_desc_authoritative:
            '潜在的な一致するアイデンティティが検出されました。以下の候補アイデンティティを確認し、既存のアイデンティティを選択してこのアカウントをマージするか、新規アイデンティティを作成してください。',
        form_section_desc_record:
        ...
        form_decisions: '決定',
        form_fusion_decision: 'Fusion の決定',
        form_candidate_details: '{{name}} の詳細',
        form_definition_description:
            '潜在的な一致するアイデンティティを確認し、新規アイデンティティを作成するか、既存のアイデンティティとマージするかを決定してください',
    },
    pt: {
        curated_view: 'Uma visão selecionada de possíveis correspondências e as evidências de pontuação por trás delas.',

        email_header_subtitle: '{{host}} - {{sourceName}}',
        fusion_source_fallback: 'Fonte Fusion',        processing_statistics: 'Estatísticas de processamento',
        ...
        please_review: 'Revise a correspondência e tome as medidas adequadas.',
        ...
        review_email_subject:
            '{{accountName}} ({{accountSource}}) - Revisar correspondência de identidade candidata',
        report_email_subject: '{{reportTitle}} - {{matchCount}} correspondência(s) requerem sua atenção',
        truncation_notice: 'Report content was truncated to fit ISC workflow input size limits.',
        dry_run_report_title: 'Identity Fusion Dry Run Report',
        fusion_report_title: 'Identity Fusion Report',
        aggregation_report_title: 'Identity Fusion Aggregation Report',
        ...
        algorithm_binary: 'Binary (Exact Match)',
        algorithm_custom: 'Custom',
        algorithm_average: 'Pontuação combinada de correspondência (legado)',
        algorithm_weighted_mean: 'Pontuação combinada',

        combined_score_attribute: 'Pontuação combinada',
        form_score_skipped: 'Skipped (missing value)',
        form_score_only: 'Score: {{score}}',
        form_score_only_with_fusion: 'Score: {{score}} [{{fusionScore}}]',
        form_score_value_combined: 'Value: {{value}} | Score: {{score}} [{{fusionScore}}]',
    ...
    it: {
        ...
        email_header_subtitle: '{{host}} - {{sourceName}}',
        fusion_source_fallback: 'Origine Fusion',        processing_statistics: 'Statistiche di elaborazione',
        ...
        please_review: 'Verifica la corrispondenza e intraprendi le azioni appropriate.',
        ...
        blended_account: 'Blended Account',
        review_email_subject:
            '{{accountName}} ({{accountSource}}) - Revisiona corrispondenza identità candidata',
        report_email_subject: '{{reportTitle}} - {{matchCount}} corrispondenza/e richiedono la tua attenzione',
        truncation_notice: 'Report content was truncated to fit ISC workflow input size limits.',
        dry_run_report_title: 'Identity Fusion Dry Run Report',
        fusion_report_title: 'Identity Fusion Report',
        aggregation_report_title: 'Identity Fusion Aggregation Report',
        ...
        algorithm_binary: 'Binary (Exact Match)',
        algorithm_custom: 'Custom',
        algorithm_average: 'Punteggio combinato di corrispondenza (legacy)',
        algorithm_weighted_mean: 'Punteggio combinato',

        combined_score_attribute: 'Punteggio combinato',
        form_score_skipped: 'Skipped (missing value)',
        form_score_only: 'Score: {{score}}',
        form_score_only_with_fusion: 'Score: {{score}} [{{fusionScore}}]',
        form_score_value_combined: 'Value: {{value}} | Score: {{score}} [{{fusionScore}}]',
    ...
    ru: {
        ...
        email_header_subtitle: '{{host}} - {{sourceName}}',
        fusion_source_fallback: 'Источник Fusion',        processing_statistics: 'Статистика обработки',
        ...
        please_review: 'Пожалуйста, проверьте совпадение и примите соответствующие меры.',
        ...
        blended: 'Blended',
        blended_account: 'Blended Account',
        review_email_subject: '{{accountName}} ({{accountSource}}) - Проверить совпадение кандидата',
        report_email_subject: '{{reportTitle}} - {{matchCount}} совпадение(й) требуют вашего внимания',
        truncation_notice: 'Report content was truncated to fit ISC workflow input size limits.',
        dry_run_report_title: 'Identity Fusion Dry Run Report',
        fusion_report_title: 'Identity Fusion Report',
        aggregation_report_title: 'Identity Fusion Aggregation Report',
        ...
        algorithm_binary: 'Binary (Exact Match)',
        algorithm_custom: 'Custom',
        algorithm_average: 'Комбинированный балл совпадения (устар.)',
        algorithm_weighted_mean: 'Комбинированный балл',

        combined_score_attribute: 'Комбинированный балл',
        form_score_skipped: 'Skipped (missing value)',
        form_score_only: 'Score: {{score}}',
        form_score_only_with_fusion: 'Score: {{score}} [{{fusionScore}}]',
        form_score_value_combined: 'Value: {{value}} | Score: {{score}} [{{fusionScore}}]',
    ...
    ar: {
        ...
        email_header_subtitle: '{{host}} - {{sourceName}}',
        fusion_source_fallback: 'مصدر Fusion',        processing_statistics: 'إحصائيات المعالجة',
        ...
        please_review: 'يرجى مراجعة المطابقة واتخاذ الإجراء المناسب.',
        ...
        blended: 'Blended',
        blended_account: 'Blended Account',
        review_email_subject: '{{accountName}} ({{accountSource}}) - مراجعة تطابق الهوية المرشحة',
        report_email_subject: '{{reportTitle}} - {{matchCount}} تطابق(ات) تتطلب انتباهك',
        truncation_notice: 'Report content was truncated to fit ISC workflow input size limits.',
        dry_run_report_title: 'Identity Fusion Dry Run Report',
        fusion_report_title: 'Identity Fusion Report',
        aggregation_report_title: 'Identity Fusion Aggregation Report',
        ...
        algorithm_binary: 'Binary (Exact Match)',
        algorithm_custom: 'Custom',
        algorithm_average: 'درجة التطابق المركبة (قديم)',
        algorithm_weighted_mean: 'الدرجة المركبة',

        combined_score_attribute: 'الدرجة المركبة',
        form_score_skipped: 'Skipped (missing value)',
        form_score_only: 'Score: {{score}}',
        form_score_only_with_fusion: 'Score: {{score}} [{{fusionScore}}]',
        form_score_value_combined: 'Value: {{value}} | Score: {{score}} [{{fusionScore}}]',
