...
export const locales: Record<string, TranslationDictionary> = {
    en: {
        ...
        fusion_source_fallback: 'Fusion source',
    ...
    es: {
        ...
        email_header_subtitle: '{{host}} - {{sourceName}}',
        fusion_source_fallback: 'Fuente Fusion',
        ...
        truncation_notice:
            'El contenido del reporte se truncó para cumplir los límites de entrada del flujo de trabajo de ISC.',
    ...
    fr: {
        ...
        email_header_subtitle: '{{host}} - {{sourceName}}',
        fusion_source_fallback: 'Source Fusion',
        ...
        form_toggle_help_no_match_record:
            'Sélectionnez ceci si l’enregistrement ne correspond à aucune identité existante',
        form_toggle_help_no_match_orphan:
    ...
    de: {
        curated_view:
            'Eine kuratierte Ansicht möglicher Übereinstimmungen und der dahinterstehenden Bewertungsnachweise.',

        email_header_subtitle: '{{host}} - {{sourceName}}',
        fusion_source_fallback: 'Fusion-Quelle',
    ...
    zh: {
        ...
        email_header_subtitle: '{{host}} - {{sourceName}}',
        fusion_source_fallback: 'Fusion 源',
    ...
    ja: {
        ...
        email_header_subtitle: '{{host}} - {{sourceName}}',
        fusion_source_fallback: 'Fusion ソース',
        ...
        form_toggle_help_no_match_record: 'レコードが既存のアイデンティティと一致しない場合はこれを選択してください',
        form_toggle_help_no_match_orphan:
    ...
    pt: {
        curated_view:
            'Uma visão selecionada de possíveis correspondências e as evidências de pontuação por trás delas.',

        email_header_subtitle: '{{host}} - {{sourceName}}',
        fusion_source_fallback: 'Fonte Fusion',
        ...
        blended: 'Blended',
        blended_account: 'Blended Account',
        review_email_subject: '{{accountName}} ({{accountSource}}) - Revisar correspondência de identidade candidata',
    ...
    it: {
        ...
        email_header_subtitle: '{{host}} - {{sourceName}}',
        fusion_source_fallback: 'Origine Fusion',
        ...
        blended: 'Blended',
        blended_account: 'Blended Account',
        review_email_subject: '{{accountName}} ({{accountSource}}) - Revisiona corrispondenza identità candidata',
    ...
    ru: {
        ...
        email_header_subtitle: '{{host}} - {{sourceName}}',
        fusion_source_fallback: 'Источник Fusion',
    ...
    ar: {
        ...
        email_header_subtitle: '{{host}} - {{sourceName}}',
        fusion_source_fallback: 'مصدر Fusion',
