              ...
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="border-collapse:separate; border-spacing:0; width:auto; min-width:100%;">
                <tr>
                  ...
                  <td style="vertical-align:top; padding-left:14px;">
                    ...
                    {{else}}
                    <div style="color:#999; font-style:italic; padding:20px; background-color:#f8f9fa; border-radius:4px; text-align:center;">No matches found for this account.</div>
                    {{/if}}
                    {{else}}
                    <div style="color:#999; font-style:italic; padding:20px; background-color:#f8f9fa; border-radius:4px; text-align:center;">No matches found for this account.</div>
                    {{/if}}
                                        ...
                                        <div style="padding-bottom:18px; margin-bottom:22px; border-bottom:1px solid #e6ebf5;">
                                            <div style="margin-bottom:12px;">
                                                ...
                                                <div style="color:#5f6b7a; font-size:13px; margin-top:6px;">
                                                    Please review the match and take appropriate action.
                                                </div>
                                                {{#each accounts}}
                                                {{#if accountSource}}
                                            ...
                                            <!-- No aggregate matches count in review email -->
                                        </div>
