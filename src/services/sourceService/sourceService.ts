...
export class SourceService {
    ...
    public getFusionSource(): SourceInfo | undefined {
        // Performance optimization: Iterate over the map values directly instead of using Array.from().find()
        // to prevent unnecessary intermediate array allocations, reducing memory overhead and garbage collection.
