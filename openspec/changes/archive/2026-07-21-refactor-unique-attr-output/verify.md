...
**Change**: `refactor-unique-attr-output`
**Verified at**: `2026-07-21`
**Verifier**: `Antigravity IDE`
...
```text
35 items validated. 35 passed, 0 failed.
```
...
|---|---|---|
| fusion-service | ✗ 待 sync | 將在 archive 階段自動 sync |
...
|---|---|---|---|
| JIT Unique Attributes | "Refactor unique attributes to happen strictly before serialization" | `fusion-service/spec.md` updated | 無 |
